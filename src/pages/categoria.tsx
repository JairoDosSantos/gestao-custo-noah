...
const Categoria = () => {
    ...
    return (
        <div className='-mt-20 p-5 flex gap-3'>
            ...
            <div className='bg-white  w-2/3 p-5 rounded shadow-md max-h-96 overflow-auto overflow-hide-scroll-bar'>
                <div className=' border-2 border-dashed rounded p-5 min-h-full'>
                    <form className='flex flex-col justify-center items-center space-y-8'>
                        ...
                        <input type="text" placeholder='Descrição da categoria *' className='px-4 py-2 border  rounded mx-2 w-72' />
